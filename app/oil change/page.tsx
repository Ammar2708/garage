...
const processSteps = [
  {
    ...
    text: "Choose a time that suits you and tell us the vehicle details before arrival.",
    image: "/imgi_13_Inner-Services-Pages-How-We-Work-Step2.webp",
  },
  {
    title: "Drain And Replace",
    text: "We remove used oil, replace the filter where required, and fit the correct grade.",
    image: "/imgi_66_Inner-Services-Pages-How-We-Work-Step4-178x179.webp",
  },
  {
    title: "Refill And Inspect",
    text: "Fresh oil is added to specification, then key levels and visible leaks are checked.",
    image: "/imgi_74_Inner-Services-Pages-How-We-Work-Step4-178x179.jpeg",
  },
  {
    title: "Drive Away Ready",
    text: "Your car leaves with smoother lubrication and a clear note of anything we noticed.",
    image: "/imgi_74_Inner-Services-Pages-How-We-Work-Step4-178x179.webp",
  },
];

const signs = [
  "Oil warning light stays on after startup",
  "Oil on the dipstick looks very dark or gritty",
  "Engine sounds louder than usual",
  "Visible oil marks under the car",
  "Exhaust smoke has changed colour",
  "Service mileage or time interval is due",
];
...
const includes = [
  "Correct oil grade checked against the vehicle requirement",
  "Used oil drained carefully from the engine",
  "Oil filter replaced where included in the service",
  "Caps, seals, and visible leak points checked",
];

const whyCards = [
  {
    title: "Careful Service",
    text: "Every oil change is completed with the right process, clean handling, and attention to manufacturer guidance.",
    icon: ShieldCheck,
  },
  {
    title: "Right Oil Choice",
    text: "We match the oil grade to the engine so lubrication, economy, and protection stay consistent.",
    icon: Droplets,
  },
  {
    title: "Useful Checks",
    text: "Our technicians look over key fluid levels and obvious wear signs while your vehicle is with us.",
    icon: ClipboardCheck,
  },
];
...
const faqItems = [
  {
    question: "Why should engine oil be changed on time?",
    answer:
      "Fresh oil reduces friction, carries heat away from moving parts, and helps protect internal engine components from everyday wear.",
  },
  {
    question: "How long does an oil change take?",
    answer:
      "Most straightforward oil and filter changes can be completed quickly, depending on the vehicle, access, oil type, and workshop schedule.",
  },
  {
    question: "How do I know which oil my car needs?",
    answer:
      "The correct oil depends on the manufacturer specification, engine type, and service history. We check those details before refilling.",
  },
  {
    question: "Can you check other fluids at the same time?",
    answer:
      "Yes. During the visit we can review important fluid levels and advise if anything needs topping up, flushing, or further inspection.",
  },
];
...
export default function EngineOilChangePage() {
  return (
    <main className="bg-white text-neutral-950">
      <section className="relative min-h-[620px] overflow-hidden bg-black text-white">
        <Image
          src="/imgi_93_car-engine-oil-change-hero-banner-e1719924772640.webp"
          alt="Engine oil being poured during a car service"
          fill
          priority
        ...
        <div className="relative mx-auto flex min-h-[620px] max-w-[1800px] flex-col justify-center px-5 py-16 lg:px-10">
          ...
          <h1 className="mt-5 max-w-5xl text-3xl font-black leading-tight sm:text-4xl lg:text-5xl">
            Professional Engine Oil Change For Smoother Daily Driving
          </h1>
          <p className="mt-6 max-w-3xl text-sm font-semibold leading-7 text-white/90 sm:text-base">
            Keep your engine protected with the correct oil grade, a clean refill process, and practical checks from technicians who understand everyday service needs.
          </p>
        ...
        <div className="mx-auto grid max-w-[1700px] items-center gap-12 lg:grid-cols-[0.85fr_1.15fr]">
          <div className="relative mx-auto min-h-[430px] w-full max-w-xl">
            <Image
              ...
              alt="Mechanic ready for engine oil change"
              fill
          ...
          <div>
            <h2 className="max-w-4xl text-2xl font-black leading-tight sm:text-3xl lg:text-4xl">
              Maintain Your Car Performance With Regular Oil Care
            </h2>
            <p className="mt-5 text-sm font-medium leading-7 text-neutral-800 sm:text-base">
              Engine oil works hard every time you drive. Over time it collects heat, dirt, and residue, which can reduce protection inside the engine. A timely oil change helps your car run cleaner, quieter, and more reliably.
            </p>
            <p className="mt-4 text-sm font-medium leading-7 text-neutral-800 sm:text-base">
              TaylorMOT provides a focused oil and filter service for drivers who want clear advice, accurate oil selection, and a straightforward appointment without unnecessary fuss.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-5 py-14 lg:px-10">
        <div className="mx-auto grid max-w-[1800px] gap-12 lg:grid-cols-[470px_1fr]">
          <aside className="space-y-8">
            <div className="overflow-hidden rounded-md bg-red-600 text-white">
              <div className="relative h-72">
                <Image src="/imgi_50_Inner-Services-Pages-Get-A-Quite-Left-Image-277x300.webp" alt="Car mechanic in workshop" fill className="object-cover" sizes="470px" />
              </div>
              <div className="px-7 py-8">
                <h3 className="text-2xl font-black">Speak With A Service Advisor</h3>
          ...
          <div>
            ...
            <p className="mt-5 text-sm font-medium leading-7 text-neutral-800 sm:text-base">
              The right interval depends on your vehicle, driving style, oil type, and manufacturer guidance. Short journeys, heavy traffic, and high mileage can make regular servicing even more important.
            </p>
            <p className="mt-4 text-sm font-medium leading-7 text-neutral-800 sm:text-base">
              If your vehicle feels rough, shows warning lights, or is past its service date, it is worth booking an oil check before the issue becomes more expensive.
            </p>
            ...
            <div className="relative mt-10 min-h-[430px] overflow-hidden rounded-md">
              <Image src="/imgi_140_aut-repair-car-oil-change-1-1.webp" alt="Engine bay oil inspection" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 62vw" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-5 py-14 lg:px-10">
        <h2 className="text-3xl font-black leading-tight text-red-600 sm:text-4xl">
          What Is Included In An Oil And Filter Change?
        </h2>
        <p className="mt-5 max-w-[1650px] text-sm font-medium leading-7 text-neutral-800 sm:text-base">
          Our service focuses on clean oil removal, correct replacement oil, and sensible inspection points. We keep the work clear so you know what has been done and why it matters for your engine.
        </p>
      ...
      <section className="px-5 py-14 lg:px-10">
        ...
        <p className="mt-5 max-w-[1700px] text-sm font-medium leading-7 text-neutral-800 sm:text-base">
          Pricing depends on the oil specification, filter type, engine size, and any extra checks requested. We confirm the requirement before work begins, so your quote is clear and matched to your vehicle.
        </p>
        <p className="mt-4 max-w-[1700px] text-sm font-medium leading-7 text-neutral-800 sm:text-base">
          For an accurate price, share your registration or vehicle details and our team will advise the correct oil and filter option.
        </p>
      </section>

      <section className="px-5 py-14 text-center lg:px-10">
        <h2 className="text-3xl font-black leading-tight sm:text-4xl">Why Choose TaylorMOT For Engine Oil Service?</h2>
