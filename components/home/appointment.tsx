...
const Appointment = () => {
  return (
    <section className="relative overflow-hidden bg-white px-4 py-10 text-black sm:px-6 lg:px-8 lg:py-14">
      <div className="mx-auto grid max-w-7xl items-center gap-8 lg:grid-cols-[0.56fr_0.44fr]">
        <div className="relative z-10 text-center lg:text-left">
          ...
          <div className="mt-7 flex flex-col items-center gap-4 sm:flex-row sm:justify-center lg:justify-start">
            <a
              ...
              className="text-3xl font-black leading-none tracking-[0.08em] text-[#f4070b] sm:text-4xl"
            >
              +44 20 3337 1831
            </a>
