      ...
      <section className="relative min-h-[700px] overflow-hidden bg-black text-white">
        ...
        <div className="relative mx-auto flex min-h-[700px] max-w-[1800px] flex-col justify-center px-5 py-24 lg:px-10">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <Link href="tel:+442033371831" className="inline-flex min-w-56 items-center justify-center gap-2 rounded-md bg-white px-8 py-4 text-sm font-black uppercase text-black transition hover:bg-neutral-200">
              <Phone size={18} />
              Call Now
            </Link>
